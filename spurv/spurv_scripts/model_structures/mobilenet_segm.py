...
def get_mobilenet_segm(seq_length, sine_steering, freeze, activation):
    ...
    x = TimeDistributed(Dense(100, activation=activation))(x)
    ...
    if sine_steering:
        ...
        steer_pred = Dense(1, activation=activation, name="steer_pred")(x)
